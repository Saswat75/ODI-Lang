...
//Assigning memory and initiating the lexer
...
//Advancing the lexer by skipping the null values and getting the contents of each line
...
//Skipping the whitespaces and 10 is for the space too (ASCII value)   
...
//Used to advance after browsing through one token and tp print the tokens accordingly 
...
//To fetch the strings from the code
...
//To collect the ID's that are in-built keywords of our language
